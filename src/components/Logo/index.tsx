...
const Logos = () => {
  return (
    <Logo radius={'10px'} bColor={'red'} src="https://assets.coingecko.com/coins/images/29850/standard/pepe-token.jpeg?1696528776"/>
    // <Group mLeft={-10}>
    ...
    //   <Logo src="" alt='BNB' bColor={'red'} color={'yellow'}/>
    // </Group>
  );
};
